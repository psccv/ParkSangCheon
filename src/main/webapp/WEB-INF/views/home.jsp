	...
	<div class="about_area">
		...
		<div class="about_box">
			<ul class="place_list box_inner clear">
				<li><a href="#"
					onclick="$('.popup_base').css('height',$(document).height());$('.contact_pop').show();">
						<img class="img_topplace"
						src="/resources/home/img/img_topplace01.jpg" alt="OOOO OOOOO" />
						<h3>OOOO OOOOO</h3>
						<p class="txt">OOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO
							OOOOOOOOO OOOOOOOOO OOOOO!</p> <span class="view">VIEW</span>
				</a></li>
				<li><a href="#"
					onclick="$('.popup_base').css('height',$(document).height());$('.space_pop').show();">
						<img class="img_topplace"
						src="/resources/home/img/img_topplace02.jpg" alt="OOOO OOOOO" />
						<h3>OOOO OOOOO</h3>
						<p class="txt">OOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO
							OOOOOOOOO OOOOOOOOO OOOOO.</p> <span class="view">VIEW</span>
				</a></li>
				<li><a href="#"
					onclick="$('.popup_base').css('height',$(document).height());$('.program_pop').show();">
						<img class="img_topplace"
						src="/resources/home/img/img_topplace03.jpg" alt="OOOO OOOOO" />
						<h3>OOOO OOOOO</h3>
						<p class="txt">OOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO
							OOOOOOOOO OOOOOOOOO OOOOO</p> <span class="view">VIEW</span>
				</a></li>
		...
		<div class="appbbs_box box_inner clear">
			...
			<div class="bbs_line">
				...
				<ul class="notice_recent">
					<li><a href="/resources/home/javascript:;">OOOO OOOOO
							(스프링OOOO OOOOO)</a></li>
					<li><a href="/resources/home/javascript:;">OOOO OOOOOOOOO
							OOOOO</a></li>
					<li><a href="/resources/home/javascript:;">OOOO OOOOO/OOOO
							OOOOO</a></li>
					<li><a href="/resources/home/javascript:;">OOOO OOOOO
							OPEN! (스프링정보, OOOO OOOOO)</a></li>
					<li><a href="/resources/home/javascript:;">OOOO OOOOO 서비스
							점검 안내</a></li>
				</ul>
			</div>
		</div>
