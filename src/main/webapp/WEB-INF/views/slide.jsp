...
.last {
	margin-right: 0;
} /* col 마지막 요소의 마진값을 없애서 레이아웃이 깨지는 것을 방지 */
...
/* 속성설명
    ...
    */
body header {
	background: url("/resources/images/geometric.jpg") no-repeat 50% 50%;
...
<body>
	...
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/maldives.jpg" alt="" width="296"
					height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/maldives.jpg" alt="" width="620"
					height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/maldives.jpg"
				...
				<li class="col-6 last"><img
					src="/resources/images/maldives.jpg" alt="" width="459"
					height="324" />
					<h5>에코바스 사이트 작업완료.</h5>
